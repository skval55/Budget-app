...
${colors.logoBlue("R")} ${colors.logoGreen("E")} ${colors.logoYellow("M")} ${colors.logoPink("I")} ${colors.logoRed("X")}
  ...
  ${colors.heading("Run your project locally in development (Classic compiler)")}:

    $ remix dev
    $ remix dev -c "node ./server.js"

  ${colors.heading("Start your server separately and watch for changes (Classic compiler)")}:
...
async function run(argv = process.argv.slice(2)) {
  ...
  let args = arg__default["default"]({
    ...
    "--tls-key": String,
    "--tls-cert": String,
    ...(argv[0].startsWith("vite:") || argv[0] === "reveal" || argv[0] === "routes" ?
