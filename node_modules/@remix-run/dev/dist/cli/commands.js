...
var colors$1 = require('picocolors');
...
var colors__default = /*#__PURE__*/_interopDefaultLegacy(colors$1);
...
async function build(remixRoot, mode, sourcemap = false) {
  ...
  logger.logger.info(`building...` + colors__default["default"].gray(` (NODE_ENV=${mode})`));
  ...
  logger.logger.info("built" + colors__default["default"].gray(` (${prettyMs__default["default"](Date.now() - start)})`));
}
...
async function generateEntry(entry, remixRoot, flags = {}) {
  ...
  let defaultEntryServer = path__namespace.resolve(defaultsDirectory, (ctx === null || ctx === void 0 ? void 0 : ctx.remixConfig.ssr) === false && (ctx === null || ctx === void 0 ? void 0 : ctx.remixConfig.future.v3_singleFetch) !== true ? `entry.server.spa.tsx` : `entry.server.${serverRuntime}.tsx`);
